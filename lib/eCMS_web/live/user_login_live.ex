  ...
  def render(assigns) do
    ...
    <div class="login-1">
      ...
      <div class="group-10-19">
        <p class="text-28"><span class="text-black">Log in to account</span></p>
        ...
        <.simple_form for={@form} id="login_form" action={~p"/users/log_in"} phx-update="ignore">
          ...
          <div class="rectangle-172-23">
            <.input field={@form[:email]} type="email" placeholder="" required class="w-full h-full bg-transparent border-0 focus:ring-0 px-3" />
          </div>

          <p class="text-22"><span class="text-black">Password</span></p>
          <div class="rectangle-173-24">
            <.input field={@form[:password]} type="password" placeholder="" required class="w-full h-full bg-transparent border-0 focus:ring-0 px-3" />
          </div>
    ...
    <div class="footer">
      <div class="copyright">
        <img src={~p"/images/copyright-34.png"} alt="copyright" />
